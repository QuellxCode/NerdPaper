                                ...
                                <tr>
                                    ...
                                    <th width="2%">Action</th>
                                                            ...
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                 <td>
                                                                 <?php if(isset($single_revised_work->order_id)):?>
                                                                 ...
                                                                 <td>
                                                                   <?php if(isset($single_revised_work->order_id)):?>
                                                                       ...
                                                                       <?php  echo 'NDP'.'-'. $single_revised_work->order_id; ?>
                                                                 ...
                                                                 <?php if(isset($single_revised_work->order_id)):?>
                                                                       ...
                                                                       <?php  echo $single_revised_work->client_email.'<br>'; ?>
                                                                       <?php  echo $single_revised_work->phone.'<br>'; ?>

                                                                   <?php endif ?>
                                                                 </td>
                                                                 <td>
                                                                  <?php if (isset($single_revised_work)): ?>
                                                                    
                                                                 
                                                                   <a href="<?php echo base_url() ?>index.php/admin/neworder/order_detail/<?php echo $single_revised_work->order_id  ?>">Detail</a>

                                                                    <?php endif ?>
                                                                 </td>
                                                                 <td>
                                                                 <?php if(isset($single_revised_work->writer_id) && !empty($single_revised_work->writer_id)):?>
                                                                 <?php $this->load->helper('writer'); 
                                          $writer_name_row = getwritername($single_revised_work->writer_id);
                                          if($writer_name_row)
                                          {
                                            echo $writer_name_row->user_name;
                                          }
                                          // echo '<pre>';
                                          // print_r($writer_name_row);
                                          // die();
                                          ...
                                          <?php endif ?>
                                                                 ...
                                                                 <td>
                                                                 <?php if(isset($single_revised_work->revised_work_note) && !empty($single_revised_work->revised_work_note)):?>
                                                                       
                                                                       <?php  echo $single_revised_work->revised_work_note; ?>
                                                                      
                                                                    <?php else :?>

                                                                    <span style="font-size: 100px;margin-left: 33px;"> </span>

                                                                   <?php endif ?>
                                                                 </td>
                                                                 <td>
                                                                   <?php if (isset($single_revised_work) && !empty($single_revised_work)): ?>

                                                                        <?php $this->load->helper('revisedwork'); 
                                          $table_free_booked = myfunc($single_revised_work->revised_work_id);
                                          ...
                                          <?php $this->load->helper('revisedwork'); 
                                          $table_free_booked = report_work($single_revised_work->revised_work_id);
                                          ...
                                          <?php endforeach ?>
                                                                 ...
                                                                 <td>
                                                                   <?php if (isset($single_revised_work) && !empty($single_revised_work)): ?>
                                                                    ...
                                                                    <?php 
                                         echo $single_revised_work->created_at.'<br>';
                                         echo $single_revised_work->created_by;
                                         ...
                                         ?>
                                                                 ...
                                                                 <td>
                                                                  <?php if (isset($single_revised_work) && !empty($single_revised_work)): ?>
                                                                   ...
                                                                   <?php if ($single_revised_work->status == 0): ?>
                                                                  <a href="<?php echo base_url(); ?>index.php/admin/revision/submit_revised_work/<?php echo $single_revised_work->revised_work_id  ?>">
                                                                ...
                                                                <?php endif ?>
                                                                 ...
                                                                 <td>
                                                                 <?php if(isset($single_revised_work->revised_work_id)):?>

                                                                        <a  title="Edit Revised Work" class="" id="<?php echo $single_revised_work->revised_work_id ?>" name="" data-toggle="modal" href="#edit_revised_work" >
                                         <i class="fa fa-pencil"></i>
                                       </a>
                                       <a onclick="deleteneworder(<?php echo $single_revised_work->revised_work_id ?>);" >
                                         <span>
