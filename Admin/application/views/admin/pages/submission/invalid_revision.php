        ...
        <div class="portlet light portlet-fit ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red sbold uppercase">Invalid Revision Request</span>
                </div>
                <!-- <div class="actions">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="neworder_tbl">
                            <thead>
                                <tr>
                                    ...
                                    <th width="6%"> Invalid Revision Note </th>
                                <!--     <th width="2%"> Status </th> -->
                                                               ...
                                                               foreach ($revisions as $key => $revision):
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> 
                                                                     ...
                                                                     <?php echo $count ?> </td>
                                                                    <td> <?php echo $revision->order_id; ?> </td>
                                                                    <td> 

                                                                        <?php echo $revision->updated_by; ?>

                                                                     <?php $this->load->helper('writer'); 
                                                                   $writername = getwritername($revision->order_id);
                                                                   if(isset($writername))
                                                                   {
                                                                   ...
                                                                   ?>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <?php echo $revision->writer_revision_note ?>
                                    ...
                                    <div class="modal fade" id="addNoteadmin" role="dialog">
                                        <div class="modal-dialog">
                                          ...
                                          <div class="modal-body">
                                              <form role="form" method="post" action="<?php echo base_url(); ?>index.php/admin/revision/approve_invalid_revision_request">

                                                <div class="form-group" id="mytextarea"> 
                                                  <label>Add Note</label>    
                                                  <textarea class="form-control" name="invalid_revision_request_note">

                                                  </textarea>
                                                  <input type="text" name="admin_revision_action" id="admin_revision_action" />

                                                  <input type="text" name="revisionid" id="myrevisionid" value="<?php echo $revision->revision_id ?>">
...
<script type="text/javascript">
    function revision_status($id,$value)
    {
      //alert($id+' '+$value);
       ...
       // alert(myvalue);
        $("#admin_revision_action").val(myvalue);
        $("#addNoteadmin").modal('show');
