...
<link rel="canonical" href="https://nerdpapers.com/order/" />
...
<!-- In this line only add Class -->
<div class="container mobile-max-width ">
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="card animated zoomInDown animation-delay-5">
          <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-tabs-transparent indicator-primary nav-tabs-full nav-tabs-3" role="tablist">
              <li class="nav-item " style="cursor: not-allowed;pointer-events: none;"><a id="pcalc" class="nav-link withoutripple <?php echo (isset($order_details))?'':'active'?>" href="#step1" aria-controls="step2" role="tab" data-toggle="tab" style="cursor: not-allowed;"><i class="zmdi zmdi-folder-outline"></i> <span class="d-none d-sm-inline">Price Calculation</span></a>
                 <span id="i1" class="ms-tabs-indicator" id="projectdetails" style="display:none;left: -12px;width: 35%"></span>
              </li>
              <li class="nav-item " style="cursor: not-allowed;pointer-events: none;"><a class="nav-link withoutripple" href="#step2" aria-controls="step2" role="tab" data-toggle="tab"><i class="zmdi zmdi-edit"></i> <span class="d-none d-sm-inline" id="projectdetailsid" style="cursor: not-allowed; color:#8c8c8c">Project Details</span></a>
                <!-- Add change Here left and width -->
                <span id="i3" class="ms-tabs-indicator" id="projectdetails" style="display:none;left: 35%;width: 35%"></span>
            </li>
        ...
        <div class="tab-content">
            <div role="tabpanel"  class="tab-pane <?php echo (isset($order_details))?'fade':'active show'?>" id="step1">
                    ...
                    <fieldset>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-4 form-group" id="yourname" onclick="yourname_focused();">
                            ...
                            <input type="hidden" id="getorderid" class="form-control" name="orderDetailId" value="<?php echo isset($or->order_detail_id)? $or->order_detail_id: '' ;?>" >
                        ...
                        <label for="inputPhone" autocomplete="false" class="col-lg-2 control-label" style="margin-top: 50px;">Your Phone</label>
                         ...
                         <div class="col-lg-4 form-group" id="yourphone" onclick="yourphone_focused();">
                            <?php if(isset($_SESSION['clientContact'])){
                             ...
                             <input type="text" placeholder="XXX-XXX-XXXX" class="form-control" id="phone"  name="phone" value="<?php if(isset($or->contact)){ echo $or->contact;}else if(isset($_SESSION['clientContact'])){echo $_SESSION['clientContact'];}else{echo ''; };?>" maxlength="17">
                        </div>

                        <label for="select111" class="col-lg-2 control-label" style="margin-top: 50px;">Type Of Document</label>

                        <div class="col-lg-4 form-group row" id="type_of_doc" onclick="type_of_doc_focused();">
              ...
              <div class="form-group row justify-content-end">
                  ...
                  <div class="col-lg-4 form-group row" id="youracademicLevel" onclick="youracademicLevel_focused();">
                      <select onchange="changeDemo();" id="mySelect" name="acedamic_level" class="form-control" data-dropup-auto="false" title="You Study at?">
                ...
                <!-- In this line only add lg-4  -->
               <div class="col-lg-4 form-group row" id="noofpages" onclick="noofpages_focused();">
                  <select onchange="changeDemo();" class="form-control " name="num_of_pages" id="mySelect2" style="z-index: 9999999 !important;"  data-dropup-auto="false" title="Select no of Pages" >
                    <?php if (isset($or->no_of_pages)){ ?><option value="<?php echo $or->no_of_pages ?>" selected><?php echo $or->no_of_pages ?> Page~ <?php echo $or->no_of_words ?> Words</option><?php }?>
        ...
        <div class="form-group row justify-content-end">
          ...
          <div class="col-lg-4 form-group"  id="selectdeadline" onclick="selectdeadline_focused();">
              ...
              <div class="col-lg-4 form-group row" id="selecttime" onclick="selecttime_focused();">
          ...
          <div class="col-md-12">
              <div class="row"><!-- row -->
                <ul class="nav nav-tabs nav-tabs-transparent1 nav-tabs-full  nav-tabs-4" role="tablist">
                  ...
                  <li></li>
                  <li></li>
                  <!--  Add Mobile Countine button class -->
                  <li  class="nav-item mobile-countine-button" ><a onclick="showhighliter();" href="#step2" id="continue" aria-controls="step2" role="tab" data-toggle="tab" class="btn btn-raised btn-primary btn-block btn-raised mt-2  nav-link"  style="border-radius: 25px; <?php if(!isset($order_details)){?>pointer-events: none;<?php }if(isset($order_details_edit)){?>pointer-events: auto;<?php }?>" > <span class="d-none d-sm-inline">Continue</span> &nbsp; <i class="fa fa-arrow-right mobile-arrow-button"></i></a>
                  </li>
              </ul>
              <i class="fa fa-lock mobile-fill-view web-view-fill" id="lockmsg" style=""> *fill all the fields first</i>
          </div><!-- row -->
          <!-- card end -->
      </div>
  </div>
  ...
  <div role="tabpanel" class="tab-pane fade " id="step2">
    <fieldset>
      <div class="form-group row">
        <!-- Add Mobile-title-button class here --> 
        <label for="title" autocomplete="false" class="col-lg-2 control-label mobile-title-button">Title</label>
        <div class="col-lg-10">
 ...
 <input id="changeSubject12" type="hidden" name="changeSubject12" value="<?php echo isset($or->subject)?$or->subject: '' ;?>">
    </div>
</div>
      <div class="form-group row" id="othersubject12" style="display: none;">
  
        <!-- Add Mobile-title-button class here --> 
       <!--  <label for="title" autocomplete="false" class="col-lg-2 control-label mobile-title-button">Title</label> -->
        <div class="col-lg-12">
          <input type="text" class="form-control" id="changeSubject" name="changeSubject11" placeholder="Subject" value="">         
      </div>
...
<div class="form-group row justify-content-end">
    ...
    <div class="col-lg-10">
       <select name="citation_style1" id="citation_style"  class="form-control " data-dropup-auto="false" title="Select a citation style">
     ...
     <input id="citationStyle" type="hidden" name="citation_style" value="<?php echo isset($or->citation_style)?$or->citation_style: '' ;?>">
</div>
</div>
   <div class="form-group row" id="othercitationdiv" style="display: none;">
        <div class="col-lg-12">
          <input type="text" class="form-control" id="othercitation" name="othercitation1" placeholder="Citation Style" value="">         
      </div>
...
<div class="form-group row justify-content-end is-empty">
    ...
    <div class="col-lg-10">
      <input type="file" name="files[]" id="inputFile4" multiple="" value="<?php echo isset($or->file)? $or->file: '';?>" onchange="ValidateSize(this)">
...
<div class="col-md-12">
  <div class="row"><!-- row -->
    ...
    <ul class="nav nav-tabs nav-tabs-transparent1 nav-tabs-full  nav-tabs-4" role="tablist">
      <li class="nav-item"><a href="#step1" id="backbtn1" onclick="showhighliterback()" aria-controls="step2" role="tab" data-toggle="tab" class="btn btn-raised btn-primary btn-block btn-raised mt-2 no-mb nav-link" style="border-radius: 25px;"><i class="fa fa-arrow-left backColor"></i> <span class="d-none d-sm-inline backColor">Back</span></a></li>
...
<!-- Here i add class mobile-title-button -->
<div role="tabpanel" class="tab-pane <?php echo (isset($order_details))?'active show':'fade'?> mobile-title-button" id="step3">
...
<tr>
    ...
    <td>
          <?php if (isset($or) && $or->payment_status == -1): ?>
        <span class="text-muted orderId"> $ 
         <?php echo isset($or->order_price)?$or->order_price / 2 : '' ;?> (Half Price) 
     </span>
      <?php else: ?> $
      <?php echo isset($or->order_price)?$or->order_price : '' ;?> 
       <?php endif; ?>
 </td>
</tr>
    ...
    <td>    
        <?php if (isset($files)){
           foreach($files as $file){
            ...
            ?>                                             
            <lable class="btn-info"><a target="_blank" href="<?php echo $repfilepath ?>/<?php echo isset($file->file_name)?$file->file_name : '' ;?>" style="color: white"><?php echo isset($file->file_name)?$file->file_name : '' ;?></a></lable>
        <?php }}?>
...
<tr>
  <td></td>
  <td><a href="#step1" onClick="showhighliterback()" aria-controls="step1" role="tab" data-toggle="tab" class="nav-link" class="nav-link withoutripple" data-toggle="tooltip" title="Edit"> <i class="fa fa-edit">edit</i></a></td>
</tr>
</table>
...
<li class="nav-item"><a href="#step1" id="step1_id" aria-controls="step1" role="tab" data-toggle="tab" class="btn btn-raised btn-primary btn-block btn-raised mt-2 no-mb nav-link" style="border-radius: 25px; color:#03a9f4 !important;display: none;"><i class="fa fa-arrow-left backColor"></i> <span class="d-none d-sm-inline backColor">Back</span></a></li>
...
<div class="modal modal-primary  registermodal" id="ms-account-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
    <div class="modal-dialog animated zoomIn animated-3x" role="document">
      <div class="modal-content" id="registermodalprb">
        <div class="modal-header d-block shadow-2dp no-pb">
          <button type="button" id="modalClose" onclick="dosomething();"  class="close d-inline pull-right mt-2" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">
              <i class="zmdi zmdi-close"></i>
          </span>
      </button>
      <div class="modal-title text-center">
        <img src="<?php echo base_url()  ?>assets/img/logo2.png" alt="" style="width: 200px;height: 80px;">
            ...
            <ul class="nav nav-tabs nav-tabs-full nav-tabs-3 nav-tabs-primary" role="tablist">
              <li class="nav-item" role="presentation">
                <a href="#ms-login-tab1" aria-controls="ms-login-tab1" role="tab" data-toggle="tab" id="loginNav" class="nav-link withoutripple <?php echo (isset($_SESSION['clientId']))?'active':''?>">
                  ...
                  <span id="registeri1" class="ms-tabs-indicator" style="display:<?php echo (isset($_SESSION['clientId']))?'block':'none'?>;left: 0px;width: 165.984px;"></span>
              </li>
              <li class="nav-item current" role="presentation">
                <a href="#ms-register-tab1" id="register-tab1" aria-controls="ms-register-tab1" role="tab" data-toggle="tab" id="registerNav" class="nav-link withoutripple">
                  ...
                  <span id="registeri2" class="ms-tabs-indicator" style="display:<?php echo (isset($_SESSION['clientId']))?'none':'block'?>;left: 165.994px; width: 165.994px;"></span>
              </li>
              <li class="nav-item" role="presentation">
                <a href="#ms-recovery-tab1" id="recoverypass" aria-controls="ms-recovery-tab1" role="tab" data-toggle="tab" class="nav-link withoutripple">
                  <i class="zmdi zmdi-key"></i> Recovery Pass</a>
                  <span id="registeri3" class="ms-tabs-indicator" style="display:none;left: 331.968px;width: 165.984px;"></span>
              </li>
          </ul>
      </div>
  </div>
          ...
          <form  id="formclientlogin" action="" method="POST" autocomplete="off">
            <fieldset>
              <div class="form-group label-floating is-empty is-focused">
                ...
                <input type="email" name="uemail" pattern=".+@.+." id="uclientEmail" class="form-control"> </div>
            </div>
...
<div role="tabpanel" class="tab-pane <?php echo (isset($_SESSION['clientId']))?'fade':'active show'?>" id="ms-register-tab1">
  <form id="formclientregister"  action="" method="POST">
    ...
    <div class="form-group label-floating is-empty is-focused">
        ...
        <input type="email" id="clientEmail2" class="form-control clientEmail" pattern=".+@.+." name="uemail" required> </div>
    ...
    <div class="form-group label-floating is-empty is-focused">
                        <!-- <div class="input-group">
                          ...
                          <div class="form-group label-floating is-empty is-focused">
                            ...
                            <label class="control-label" for="">Contact</label>
                            <input type="tel" id="clientcontact" placeholder="+1 XXX-XXX-XXXX" class="form-control" name="ucontact"  maxlength="12" required style="width:423px"> </div>  
                        </div>   
                          <!-- <div class="input-group">
                          <span class="input-group-addon">
                            <i class="zmdi zmdi-phone"></i>
                    ...
                    <input style="position: relative; top: 2px;" type="checkbox" id="termsandconditions" name="conditions" required="required" />
                    <!-- <input type="checkbox" name="acceptRules" class="inline checkbox" id="checkbox1" value="false"> -->
                    <input type="hidden" name="acceptRules" class="inline checkbox" id="checkbox-value" value="false">
...
<script>
      ...
      function changeDemo()
      {
$('#secondStepService').attr('checked', false);
...
<script type="text/javascript">
    ...
    $('#project_subject').on('change', function(){
       ...
       document.getElementById("changeSubject12").value  = subject;
       //alert(subject);
       if(subject =='Other'){
        $('#othersubject12').css('display','block');
    }else{
      $('#othersubject12').css('display','none');  
  }
});
    $("#changeSubject").on("change", function() {
   //alert($(this).val()); 
   document.getElementById("changeSubject12").value  = $(this).val();
});
   ...
   // Change citation style
    $('#citation_style').on('change', function(){
       ...
       var cit_style = $('#citation_style option:selected').attr('value');
       document.getElementById("citationStyle").value  = cit_style;
       //alert(subject);
       if(cit_style =='Other'){
        $('#othercitationdiv').css('display','block');
    }else{
      $('#othercitationdiv').css('display','none');  
  }
});
    $("#othercitation").on("change", function() {
   //alert($(this).val()); 
   document.getElementById("citationStyle").value  = $(this).val();
});
// /////////////
...
// var duedate = document.getElementById("datePicker").value;
// var duetime = document.getElementById("select111").value;

// $.ajax({
//    type: "POST",
//    url: "Client/generate_lead", 
//    data: {name: name, email : email,phone: phone, documentType : documentType,academicLevel: academicLevel, no_of_page : no_of_page,quotedPrice: quotedPrice, duedate : duedate,duetime:duetime},
...
<script type="text/javascript">
  ...
  function updatefunction(){
      ...
      var x9 = document.forms["myForm"]["changeSubject12"].value;
      var x10 = document.forms["myForm"]["citationStyle"].value;
    //   var x11 = document.forms["myForm"]["name_of_sources"].value;
    //   var x12 = document.forms["myForm"]["description"].value;


      if (x1 == "") {
          swal("Please enter a valid name at step 1. Use back button to go to step 1", "", "warning");
          //return false;
      }else if (x2 == "") {
          swal("Please enter a valid email at step 1. Use back button to go to step 1", "", "warning");
          //return false;
      }else if (x3 == "") {
          swal("Please enter a valid contact at step 1. Use back button to go to step 1", "", "warning");
          //return false;
      }else if (x4 == "") {
          swal("Please enter a valid document type at step 1. Use back button to go to step 1", "", "warning");
          //return false;
      }else if (x5 == "") {
          swal("Please enter a valid academic level at step 1. Use back button to go to step 1", "", "warning");
          //return false;
      }else if (x6 == "") {
          swal("Please enter a valid date at step 1. Use back button to go to step 1", "", "warning");
          //return false;
      }else if (x7 == "") {
          swal("Please enter a valid time at step 1. Use back button to go to step 1", "", "warning");
          //return false;
      }else if (x8 == "") {
 ...
 function registerfunction(){
    ...
    $('#i2').css({left:'479px'});
    $("#pricecalculationid").css({color:'blue'});
    $("#pricecalculationid").removeAttr('style');
    $("#projectdetailsid").css({color:''});
    ...
    //   var x11 = document.forms["myForm"]["name_of_sources"].value;
    //   var x12 = document.forms["myForm"]["description"].value;
      var x13 = document.forms["myForm"]["num_of_pages"].value;
     
     
     var regularExpression = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))){2,6}$/i;

       var toalert = regularExpression.test(x2);
      ...
      if (x1 == "") {
        ...
        swal("Please enter a valid Academic Level at step 1. Use back button to go to step 1!", "", "warning");
          //return false;
                  ...
                  swal("Please enter a valid Number of Pages at step 1. Use back button to go to step 1!", "", "warning");
        ...
        swal("Please enter a valid Time at step 1. Use back button to go to step 1!", "", "warning");
            ...
            {
              swal("Email format must be correct!", "", "warning");
            }
 ...
 $('#clientLogin').on('click', function(e) {
   ...
   $.ajax({
       ...
       function(data){
                 if(data == 0){
                    swal("Email OR Password is incorrect", "", "warning");
                    $("#formsubmit_order").submit(function(){
                        e.preventDefault();
                      });
                 }
                 else if(data != 0){
...
//  Condition for Client Register with ajax
 $('#clientRegister1').on('click', function(e) {
    ...
    //var termsandconditions = document.getElementById("checkbox-value").value;
   ...
   // e.preventDefault();
    ...
    if(name ==''){
        ...
        swal("Password do not Match!", "", "warning");
            ...
            swal("PLEASE ACCEPT THE TERMS OF USE!", "", "warning");
...
var refError = 'https://www.jqueryscript.net/tags.php?/Validation/';
 var error = $("#phone").intlTelInput("get<a href="refError">Validation</a>Error");
...
//alert(number.toString().length);
        ...
        var codelength = getcode.toString().length;
        number = number.replace(/(\d{1})(\d{3})(\d{3})(\d{4})/,"$1 ($2) $3 $4");
        $(this).val(getcode+number);
        // alert(codelength);
...
<script>
 var fulhalf = "";
   ...
   var recpname = "";
   $( document ).ready(function() {
    var getorder_id =  document.getElementById("getorderid").value;
    $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() ?>index.php/order/get_checkbox_bit", 
                    data: {orderid : getorder_id },
                    dataType: "text",  
                    cache:false,
                    success: function(data){
                       // alert(data);
...
onAuthorize: function(data, actions) {
    ...
    return actions.payment.get().then(function(data) {
        ...
        $.ajax({
            ...
            data: {myorderid:getorder_id,recipient_name: shipping.recipient_name, line1 :shipping.line1, city:shipping.city, state:shipping.state, postal_code:shipping.postal_code, country_code:shipping.country_code,paidamount:myprice,sessionid : pay_session_id},
            dataType: "text",  
            cache:false,
            success: function(data){
                if(data == 'success')
...
payment: function(data, actions) {
    return actions.payment.create({
        payment: {
            transactions: [
            {
                amount: { total: myprice / 2, currency: 'USD' }
            }
            ],
            redirect_urls: {
              return_url: 'https://nerdpapers.com/index.php/payment/index/done'
...
// for de-activate nav-tab Price calculation
 $('#continue').on('click', function(e) {
$('#pcalc').removeClass('active');
 });
...
$('#registeri1').css('display','block');
$('#registeri2').css('display','none');
$('#registeri3').css('display','none');
 });
 $('#register-tab1').on('click', function(e) {
$('#registeri2').css('display','block');
$('#registeri1').css('display','none');
$('#registeri3').css('display','none');
 });
 $('#recoverypass').on('click', function(e) {
$('#registeri3').css('display','block');
$('#registeri1').css('display','none');
$('#registeri2').css('display','none');
 });
</script>
...
<script>
    var blog = GetURLParameter('order');
    //alert(blog);
</script>
<script>
    function testme()
    {
        //alert("workingss");
        $("#ms-account-modal").hide();
        $("#registermodalprb").css('display','none');
        //location.reload(true);
       // window.location.reload(true);
       $.noConflict();
       $('#mycustombody').removeClass('modal-open');
...
<script>
    $("#dashboardbtn").on('click',function()
    {
       // alert("working");
        $("#ms-account-modal").hide();
        $("#ms-account-modal").css('display','none');
...
<!--  on change validation for 1st step -->

<script type="text/javascript">
// validations

var sessionedit = '<?php echo isset($order_details)?1:0 ; ?>';

$('#inputname').on('change', function(){
        if($(this).val() =='' && sessionedit != 0){;
            $('#continue').css( 'pointer-events', 'none' );
            swal("Name not filled out", "", "warning");
        }else if($(this).val() !='' && sessionedit != 0){
           $('#continue').css( 'pointer-events', 'auto' );
        }
    });

    $('#inputEmail').on('change', function(){
        if($('#inputEmail').val() =='' && sessionedit != 0){
            swal("Email not filled out", "", "warning");
            $('#continue').css( 'pointer-events', 'none' );
        }else if($('#inputEmail').val() !='' && sessionedit != 0){
           $('#continue').css( 'pointer-events', 'auto' );
        }
    });

    $('#phone').on('change', function(){
        if($('#phone').val()=='' && sessionedit != 0){
            swal("Phone not filled out", "", "warning");
            $('#continue').css( 'pointer-events', 'none' );
        }else if($('#phone').val() !='' && sessionedit != 0){
           $('#continue').css( 'pointer-events', 'auto' );
        }
    });

    $('.doctype').on('change', function(){
        if($('.doctype option:selected').attr('value') =='' && sessionedit != 0){
            swal("Document type not selected", "", "warning");
           $('#continue').css( 'pointer-events', 'none' );
        }else if($('.doctype option:selected').attr('value') !='' && sessionedit != 0){
           $('#continue').css( 'pointer-events', 'auto' );
        }
    });

    $('#mySelect').on('change', function(){
        if($('#mySelect option:selected').attr('value') =='' && sessionedit != 0){
            swal("Academic Level not selected", "", "warning");
            $('#continue').css( 'pointer-events', 'none' );
        }else if($('#mySelect option:selected').attr('value') !='' && sessionedit != 0){
           $('#continue').css( 'pointer-events', 'auto' );
        }
    });

    $('#mySelect2').on('change', function(){
        if($('#mySelect2 option:selected').attr('value') =='' && sessionedit != 0){
            swal("Pages not selected", "", "warning");
            $('#continue').css( 'pointer-events', 'none' );
        }else if($('#mySelect2 option:selected').attr('value') !='' && sessionedit != 0){
           $('#continue').css( 'pointer-events', 'auto' );
        }
    });

    $('.endTime').on('change', function(){
        if($('.endTime option:selected').attr('value')=='' && sessionedit != 0){
            swal("Due date not Selected", "", "warning");
            $('#continue').css( 'pointer-events', 'none' );
        }else if($('.endTime option:selected').attr('value')!='' && sessionedit != 0){
           $('#continue').css( 'pointer-events', 'auto' );
        }
    });
</script>
  <script type="text/javascript">
    $(document).ready(function(){
        $('#inputFile4').change(function(){
           ...
           if (lg > 0) {
               for (var i = 0; i < lg; i++) {
                   fileSize = fileSize+items[i].size/ 1024 / 1024;; // get file size
               }
               if(fileSize > 30) {
                swal("File Size exceeded! Please email files at : info@nerdpapers.com ", "", "warning");
                document.getElementById("inputFile4").value = '';
               }
           }
        });
    });
...
<!-- SCRIPTS FOr VALIDATE STEP 1 AND LEAD GENRATE-->
<script type="text/javascript">
 // all text fields

        $("#inputname,#inputEmail,#phone,#datePicker,#mySelect,#mySelect2,#documentType,#select111").on('change', function(){
                ...
                var no_of_page1 = $('#mySelect2 option:selected').attr('value');
                var quotedPrice1 = document.getElementById("totalPrice").value;
                var duetime1 = $('.endTime option:selected').attr('value');
                ...
                if(name1 == ''){
                   ...
                   $('#noofpages').addClass("form-group row is-empty is-focused");
                    ...
                    $.ajax({
                           type: "POST",
                           url: "<?php echo base_url() ?>index.php/Client/generate_lead", 
                           data: {name: name1,email:email1,phone:phone1,documentType:documentType1,academicLevel:academicLevel1, no_of_page:no_of_page1,quotedPrice:quotedPrice1,duedate:duedate1,duetime:duetime1},
...
// dropdowns validate
//  $("#mySelect,#documentType,#selecttime,#datePicker").on('change', function(){
// $("#mySelect2 option:selected").prop("selected", false);
//  });
