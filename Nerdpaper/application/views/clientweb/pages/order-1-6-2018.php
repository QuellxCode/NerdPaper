                        ...
                        <fieldset>
                          ...
                          <div class="form-group row justify-content-end">
                            ...
                            <div class="col-lg-4">
                              ...
                              <input type="tel" class="form-control" id="phone" name="phone" data-inputmask="'mask': '0000-0000000" placeholder="Phone" value="<?php echo isset($or->phone)? $or->phone: '';?>"onkeypress="return isNumberKey(event)"  pattern="[1-9]{1}[0-9]{9}">
                            </div>

                            <label for="select111" class="col-lg-2 control-label">Type Of Document</label>

                            <div class="col-lg-4">
                              <select id="documentType" class="form-control selectpicker doctype" name="document_type" data-dropup-auto="false">
                          ...
                          <div class="col-lg-4" id="othersubject" style="display: none">
                              <input type="text" class="form-control" id="typesub" name="document_type1" placeholder="other" value="" >
                            </div>
                          ...
                          <label for="datePicker" class="col-lg-2 control-label">Select Deadline</label>
                            <div class="col-lg-4">
                              <input id="datePicker" onchange="changeDemo();"  name="datePicker" type="text" class="form-control datePicker"> </div>
                    ...
                    <fieldset>
                      ...
                      <div class="form-group label-floating">
                        <div class="input-group">
                          ...
                          <input type="tel" id="clientcontact" class="form-control" name="ucontact" onkeypress="return isNumberKey(event)" required> </div>
                      </div>
                      <div class="form-group label-floating">
                        <div class="input-group">
                          <span class="input-group-addon">
                  ...
                  <fieldset>
                    ...
                    <div class="form-group label-floating">
                      <div class="input-group">
                        ...
                        <label class="control-label" for="">Email</label>
                        <input type="email" id="" class="form-control"> </div>
                    </div>
...
$('.endTime').on('change', function(){
       ...
       // var duedate = document.getElementClassName("datePicker").value;
