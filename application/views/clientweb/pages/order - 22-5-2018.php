<div class="container ">
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="card animated zoomInDown animation-delay-5">
              <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-tabs-transparent indicator-primary nav-tabs-full nav-tabs-3" role="tablist">
                  <li class="nav-item"><a class="nav-link withoutripple <?php echo (isset($order_details))?'':'active '?>" href="#step1" aria-controls="step2" role="tab" data-toggle="tab"><i class="zmdi zmdi-folder-outline"></i> <span class="d-none d-sm-inline">Price Calculation</span></a></li>
                  ...
                  <li class="nav-item"><a class="nav-link withoutripple <?php echo (isset($order_details))?'active':''?>" href="#step3" aria-controls="step3" role="tab" data-toggle="tab"><i class="fa fa-info"></i> <span class="d-none d-sm-inline">Review Info</span></a></li>
                </ul>
            ...
            <form id="formsubmit_order" method="post"  action="<?php echo base_url().'index.php/client/'.$action; ?>"  enctype="multipart/form-data">
                        <fieldset>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                            <input type="text" class="form-control"  id="inputname" placeholder="Name" value="<?php if(isset($or->client_name)){ echo $or->client_name;}else if(isset($_SESSION['uname'])){echo $_SESSION['uname'];}else{echo ''; };?>" >
                          ...
                          <div class="form-group row justify-content-end">
                            ...
                            <div class="col-lg-4">
                              ...
                              <input type="number" class="form-control" id="phone" name="phone" data-inputmask="'mask': '0000-0000000" placeholder="Phone" value="<?php echo isset($or->phone)? $or->phone: '';?>" >
                            </div>
                            ...
                            <div class="col-lg-4">
                              <select id="select111" class="form-control selectpicker doctype" name="document_type" data-dropup-auto="false">
                                <?php if (isset($or->document_type)){ ?><option value="<?php echo $or->document_type?>"><?php echo $or->document_type ?></option><?php }?>
                          ...
                          <!-- style="display: none;" -->
                            ...
                            <div class="col-md-4">
                              <select class="form-control selectpicker" name="no_of_pages" id="mySelect2" style="z-index: 9999999 !important;" onchange="changeDemo();//myFunction2(document.getElementById('demo1').innerHTML)" data-dropup-auto="false">
                                <?php if (isset($or->no_of_pages)){ ?><option value="<?php echo $or->no_of_pages ?> ~ <?php echo $or->no_of_words ?>"><?php echo $or->no_of_pages ?> ~ <?php echo $or->no_of_words ?></option><?php }?>
                          ...
                          <label for="datePicker" class="col-lg-2 control-label">Select Deadline</label>
                            <div class="col-lg-4">
                              <input id="datePicker" onchange="changeDemo();"  name="end_date" type="text" class="form-control" value="<?php echo isset($or->end_date)? $or->end_date: '' ;?>"> </div>
                            ...
                            <?php if (isset($or->end_time)){ ?><option value="<?php echo $or->end_time?>"><?php echo $or->end_time ?></option><?php }?>
                    ...
                    <div class="card card-primary" id="myPriceCard">
                      ...
                      <div class="card-body">
                        ...
                        <h3>
                          ...
                          <input type="hidden" name="order_price" value="" id="">
            ...
            <div class="col-md-12">
                  <div class="row"><!-- row -->
                    ...
                    <select name="project_subject" id="project_subject" class="form-control selectpicker"  data-dropup-auto="false">
                        <?php if (isset($or->subject)){ ?><option value="<?php echo $or->subject?>"><?php echo $or->subject ?></option><?php }?>
                                <option value="0" >Select your course name</option>
                              ...
                              <input id="changeSubject1" type="hidden" name="changeSubject1" value="<?php echo isset($or->subject)?$or->subject: '' ;?>">
                            </div>
                          </div>
                         ...
                         <select name="citation_style" id="citation_style"  class="form-control selectpicker" data-dropup-auto="false">
                            <?php if (isset($or->citation_style)){ ?><option value="<?php echo $or->citation_style?>"><?php echo $or->citation_style ?></option><?php }?>
                          ...
                          <div class="form-group row">
                            <label for="guidelines" autocomplete="false" class="col-lg-2 control-label">Number Of Sources</label>
                          ...
                          <div class="form-group row justify-content-end is-empty">
                            ...
                            <div class="col-lg-10">
                              ...
                              <div class="input-group">
                                <input type="text" readonly="" class="form-control" value="<?php echo isset($or->file)?$or->file: '' ;?>"">
...
<div class="col-md-12">
           ...
           <?php if(!isset($order_details)){?>
                      ...
                      <?php }else{?>
                      <li  class="nav-item"><input  type="submit" value="Update" class="btn btn-raised btn-primary btn-block btn-raised mt-2 no-mb nav-link" style="border-radius: 25px;height: 50px;"/> </li>
                      <?php }?>
                    </ul>
 ...
 <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <td> Order Id </td>
                            ...
                            <td>
                                <span class="text-muted orderId"> 
                                   <?php echo isset($or->order_price)?$or->order_id : '' ;?> 
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <span class="text-muted worktype"> 
                                    <?php echo isset($or->order_price)?$or->document_type : '' ;?>
                                     </span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span class="text-muted academicLevel">
                                       <?php echo isset($or->order_price)?$or->order_price *2: '0' ;?>
                                    </span>
                                </td>
                            </tr>
                             <tr>
                                ...
                                <td>
                                    <span class="text-muted subject"> 
                                        <?php echo isset($or->order_price)?$or->subject : '' ;?>
                                     </span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php echo isset($or->order_price)?$or->title : '' ;?>
                                     </span>
                                </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                  <span class="text-muted CitationStyle"> 
                                    <?php echo isset($or->order_price)?$or->citation_style : '' ;?>
                                  </span>
                              </td>
                          </tr>
                          <tr>
                              ...
                              <td>
                                  <span class="text-muted no_of_pages"> 
                                 <?php echo isset($or->order_price)?$or->no_of_pages .'~'. $or->no_of_words: '' ;?>
                                   </span>
                              </td>
                          </tr>
                          ...
                          <tr>
                              ...
                              <td>
                                 ...
                                 <?php echo isset($or->order_price)?$or->end_date. $or->end_time : '' ;?>
                                   </span>
                              </td>
                          </tr>
                        ...
                        <tr>
                            ...
                            <td>                                                 
                              <a href="<?php echo base_url(); ?>index.php/file/pdf/<?php echo isset($or->file)?$or->file : '' ;?>"><?php echo isset($or->file)?$or->file : '' ;?></a>
                      ...
                      <tr>
                          <td></td>
                          <td><a href="#step1" aria-controls="step1" role="tab" data-toggle="tab" class="nav-link" class="" data-toggle="tooltip" title="Review&Checkout"> <i class="fa fa-edit">edit</i></a></td>
                      </tr>
                    </table>
        ...
        <div class="modal-dialog animated zoomIn animated-3x" role="document">
          <div class="modal-content">
              ...
              <div class="modal-header-tabs">
                <ul class="nav nav-tabs nav-tabs-full nav-tabs-3 nav-tabs-primary" role="tablist">
                  <li class="nav-item" role="presentation">
                    <a href="#ms-login-tab1" aria-controls="ms-login-tab" role="tab" data-toggle="tab" class="nav-link active withoutripple">
                      <i class="zmdi zmdi-account"></i> Login</a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a href="#ms-register-tab1" aria-controls="ms-register-tab" role="tab" data-toggle="tab" class="nav-link withoutripple">
                      <i class="zmdi zmdi-account-add"></i> Register</a>
                  </li>
                  <li class="nav-item" role="presentation">
                    <a href="#ms-recovery-tab1" aria-controls="ms-recovery-tab" role="tab" data-toggle="tab" class="nav-link withoutripple">
            ...
            <div class="modal-body">
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active show" id="ms-login-tab1">
                    ...
                    <fieldset>
                      <div class="form-group label-floating">
                        <div class="input-group">
                          ...
                          <label class="control-label" for="ms-form-user">User Email</label>
                          <input type="email" name="uemail" id="clientEmail" class="form-control"> </div>
                      </div>
                      <div class="form-group label-floating">
                        <div class="input-group">
                          <span class="input-group-addon">
                          ...
                          <input type="password" name="upassword"  id="clientPassword" class="form-control"> </div>
                      </div>
                      <div class="row mt-2">
                        <div class="col-md-6">
                ...
                <div role="tabpanel" class="tab-pane fade" id="ms-register-tab1">
                    ...
                    <fieldset>
                      ...
                      <div class="form-group label-floating">
                        <div class="input-group">
                          ...
                          <input type="email" id="clientEmail1" class="form-control clientEmail" name="uemail" required> </div>
                      ...
                      <div class="form-group label-floating">
                        <div class="input-group">
                          ...
                          <label class="control-label" for="ms-form-email-r">Contact</label>
                          <input type="number" id="clientcontact" class="form-control" name="ucontact" required> </div>
                      </div>
                      <div class="form-group label-floating">
                        <div class="input-group">
                          <span class="input-group-addon">
                      ...
                      <button type="submit" id="clientRegister" class="btn btn-raised btn-block btn-primary">Register Now</button>
                    </fieldset>
                  </form>
                </div>
   ...
   <script>
    ...
    <script type="text/javascript">
      $('#project_subject').on('change', function(){
       ...
       // document.getElementById("changeSubject1").value  = $(this).value();
       var paymentStatus = $('#payment option:selected').attr('value');
...
$('.endTime').on('change', function(){
  ...
  <script type="text/javascript">
    //  $('#registerModal').on('click', function() {
        ...
        // var title = document.getElementById("guidelines_title").value;
        ...
        // var name_of_sources = document.getElementById("guidelines").value;
        // var description = document.getElementById("textArea").value;
        // var file = document.getElementById("inputFile4").value;
        // var paymentStatus = document.getElementById("paymentStatus").value;
        // var no_of_word= no_of_page1.substr(no_of_page1.indexOf('~')+1);

      //     $.ajax({
      //        type: "POST",
      //        url: "client/addOrder", 
      //        data: $('#formsubmit_order').serialize(),
      //        cache:false,
      //        success: 
      //        function(data){
      //           alert(data);
...
<script type="text/javascript">
$("#clientEmail1").on('change', function() {
    var msg = $('#errormsg1');
    msg.html(" ");
    var email = document.getElementById("clientEmail1").value;
    $.ajax({ 
        cache: false,
        dataType:"html",
        type: 'POST',
...
<script type="text/javascript">
// $("#clientRegister").on('submit', function() {
...
//         data:{uname:name,uemail:email,ucontact:ucontact,upassword:upassword},
//         success:function(data){
//                 alert("success");
//             }
//     });
...
<script type="text/javascript">
// $("#clientLogin").on('submit', function() {
...
$('#clientLogin').on('click', function() {
     var upassword = document.getElementById("clientPassword").value;
...
$('#clientRegister').on('click', function() {
