...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets_material/assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>assets_material/assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
    ...
    <link href="<?php echo base_url(); ?>assets_material/assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="<?php echo base_url(); ?>assets_material/assets/pages/img/loginlogo.png" alt="" /> </a>
            </div>
            <!-- END LOGO -->
            <!-- BEGIN LOGIN -->
            ...
            <div class="content">
                <!-- BEGIN LOGIN FORM -->
                <form method="post" action="<?php echo base_url() ?>index.php/admin/login/check" >
                    ...
                    <?php endif ?>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn green uppercase center-block">Login</button>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="copyright"> © 2018 Qullexcode. All Rights Reserved. Powered by Qullexcode </div>
        <!--[if lt IE 9]>
...
<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="<?php echo base_url(); ?>assets_material/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets_material/assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets_material/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="<?php echo base_url(); ?>assets_material/assets/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?php echo base_url(); ?>assets_material/assets/pages/scripts/login.min.js" type="text/javascript"></script>
