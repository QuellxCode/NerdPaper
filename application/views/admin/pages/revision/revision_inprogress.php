                                    ...
                                    <th width="2%">Notes</th>
                                          ...
                                          <?php endforeach ?>
                                                                  ...
                                                                  <td>
                                                                   ...
                                                                   $newDate_created_at = date("d-m-Y H:i:s", strtotime($revision->created_at_pacific)); 
                                                                   
                                                                    echo $newDate_created_at;
                                                      ?>
                                                                  <?php  ?>
...
$("#revision_forward_time"+result['order_id']).html("<span style='color:black;font-weight:bold'>"+result['order_datetime2']+"</span>");
