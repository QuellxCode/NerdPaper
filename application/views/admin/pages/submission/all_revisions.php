                                ...
                                <div class="btn-group">
                                    ...
                                    <tbody>
                                     ...
                                     foreach ($revisions as $key => $revision):
                                      ...
                                      <td>
                                        ...
                                        <?php $newDate = date("d-m-Y H:i:s", strtotime($revision->created_at)); ?>
                                 ...
                                 <td>
                                    ...
                                    <!--  <a href="<?php  echo base_url(); ?>index.php/admin/revision/show_vr_ivr/<?php echo $revision->revision_id ?>" class="btn btn-success">
                                     ...
                                     <?php if ($revision->status == 5): ?>
<a title="VR / IVR" class="btn btn-success" id="<?php echo $revision->revision_id ?>" name="<?php echo $revision->status; ?>" data-toggle="modal" href="#vr_ivr" value='' style="background:red;">
 <span>VR/IVR</span>
  </a>
<?php else: ?>
<a  title="VR / IVR" class="btn btn-success" id="<?php echo $revision->revision_id ?>" name="<?php echo $revision->status; ?>" data-toggle="modal" href="#vr_ivr" value='' >
 <span>VR/IVR</span>
    </a>
<?php endif?>
...
<script type="text/javascript">
  ...
  {
    $("#allrevision_head").html("<h5><b>All Revisions </b> </h5>");
    ...
    $('#vr_ivr').on('show.bs.modal', function(e) {
      ...
      $.ajax({
        ...
        success : function (data)
        {
          ...
          $("#invalid_revisionnote").html(value['rejection_note_desc']);
        }
